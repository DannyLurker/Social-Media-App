...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    const resetPasswordReq = async () => {
      return await axios.post(`${BASE_API_URL}/users/reset-password`, data, {
        withCredentials: true,
      });
    };

    const result = await handleAuthRequest(resetPasswordReq, setIsLoading);
  ...
  return (
    <div className="h-screen flex items-center justify-center flex-col">
      ...
      <input
        type="number"
        className="block w-[90%] sm:w-[80%] md:w-[60%] lg:w-[40%] xl:w-[30%] mx-auto px-6 py-3 rounded-lg outline-none bg-gray-300"
